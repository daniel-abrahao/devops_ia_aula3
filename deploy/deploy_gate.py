...
O risk_score deve ser um número entre 0 e 100, onde 0 é risco mínimo e 100 é risco máximo. Cada motivo listado no reason deve contribuir para o cálculo do risk_score. Por exemplo, uma cobertura de testes baixa pode adicionar 50 pontos ao risco, enquanto um erro crítico nos logs pode adicionar 40 pontos.
O reason deve ser uma explicação curta e objetiva, listando todos os motivos que levaram à decisão, separados por vírgula. 
Se a decisão for APPROVE, o reason deve destacar os pontos positivos do build.
"""
