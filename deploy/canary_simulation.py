...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Executa simulação de canary deploy com métricas em JSON."
    )
    parser.add_argument(
        "--metrics-json",
        required=True,
    ...
    arquivo_metricas = Path(args.metrics_json)

    if not arquivo_metricas.is_absolute():
        arquivo_metricas = (raiz / arquivo_metricas).resolve()
